...
(def O2 (neighbors (xyz-str->atoms "H 0 0 0\nH 1.21 0 0") 0.2 1.1))
...
(def carbon-dioxide
 ...
 "O 0.0 0.0 0.0
  ...
  O 2.6600    0.0000    0.0000"))


(def formic-acid
 (xyz/xyz-str->atoms
  "C	0.0000	0.4236	0.0000
O	-1.0344	-0.4399	0.0000
O	1.1650	0.1081	0.0000
H	-0.3756	1.4558	0.0000
H	-0.6691	-1.3429	0.0000"))
