...
(defn Ry->eV [x] (cmato/* x 13.605693122994))
(defn eV->Ry [x] (cmato// x 13.605693122994))
...
(defn Angstrom->cm [x] (cmato/* x 1.0E-8))
...
(defn atomic-mass->mass [au]
  "Converts the mass to grams"
  (cmato/* au 1.6605 (cmat/pow 10 -24)))
            "Es", "Fm", "Md", "No", "Lr", "Rf", "Db", "Sg", "Bh", "Hs", "Mt",
                        "Uun", "Uuu", "Uub","", "Uuq", "", "Uuh", "", "Uuo"])
